      ...
      <div class="brand-side">
        ...
        <div class="brand-content">
          ...
          <div class="brand-middle">
            <h1 class="hero-title">
              Kuza Biashara Yako Kwa Nguvu Ya <span class="gradient-text">WhatsApp</span>.
            </h1>
            <p class="subtitle">
              Fikia wateja wengi kwa haraka, toa huduma bora, na ukuze mauzo kupitia mfumo salama wa
              kimataifa unaotumika na biashara zaidi ya 10,000+.
            </p>
          ...
          <transition name="fade-slide" mode="out-in">
            ...
            <div v-if="showPrivacy" key="privacy" class="glass-card privacy-card">
              ...
              <div class="privacy-content custom-scrollbar">
                <div class="p-section">
                  <h3>1. Utangulizi</h3>
                  <p>
                    Kedesh Limited ("sisi", "yetu") inamiliki na kuendesha mfumo wa Kedesh Bulk SMS.
                    Tunathamini faragha yako na tumejitolea kulinda taarifa zako binafsi na za
                    kibiashara. Sera hii inaeleza jinsi tunavyokusanya, kutumia, na kulinda data
                    zako unapotumia mfumo wetu kupitia Facebook Login na WhatsApp Business API.
                  </p>
                </div>
                <div class="p-section">
                  ...
                  <ul>
                    <li>
                      <strong>Taarifa za Biashara:</strong> Jina la biashara, jina la mmiliki, namba
                      ya simu ya WhatsApp.
                    </li>
                    <li>
                      <strong>Taarifa za Meta:</strong> Facebook ID, WhatsApp Business Account ID
                      (WABA), Phone Number ID kupitia Facebook Login.
                    </li>
                    <li>
                      <strong>Data za Ujumbe:</strong> Metadata za ujumbe (status, timestamp) kwa
                      ajili ya kuripoti.
                      <strong>HATUSOMI wala kuhifadhi maudhui ya meseji za wateja wako.</strong>
                    </li>
                  </ul>
                </div>
                <div class="p-section">
                ...
                <div class="p-section">
                  ...
                  <ul>
                    ...
                    <li>
                      Uhifadhi wa data kwenye seva salama zilizo na ulinzi wa kimwili na kidigitali.
                    </li>
                  </ul>
                </div>
                <div class="p-section">
                ...
                <div class="p-section">
                  <h3>6. Mawasiliano</h3>
                  <p>
                    Kama una swali lolote, changamoto, au unahitaji msaada kuhusu Sera hii ya
                    Faragha au ulinzi wa data zako, tafadhali wasiliana nasi kupitia:
                  </p>
                ...
                >
                  ...
                  <span v-else class="fb-content">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
                      <path
                        d="M12 2.04c-5.5 0-10 4.48-10 10.02 0 5 3.66 9.15 8.44 9.9v-7H7.9v-2.9h2.54V9.85c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.23.19 2.23.19v2.47h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.45 2.9h-2.33v7a10 10 0 0 0 8.44-9.9c0-5.54-4.5-10.02-10-10.02Z"
                      />
                    </svg>
                    Endelea na Facebook
                  </span>
            ...
            <div v-else key="register" class="glass-card">
              <div class="form-header">
                ...
                <p>
                  Hatua ya <strong>{{ step }}</strong> kati ya 3 • Inachukua chini ya dakika 1
                </p>
              </div>
                ...
                <transition name="slide-left" mode="out-in">
                    ...
                    <div class="input-group">
                      ...
                      <div class="modern-input-wrapper" :class="{ 'is-focused': bizFocused }">
                        ...
                        <input
                          ...
                          class="modern-input"
                          placeholder="Mfano: KEDESH LIMITED"
                          required
                          @focus="bizFocused = true"
                          @blur="bizFocused = false"
                        />
                      </div>
                    </div>
                    <div class="input-group mt-3">
                      ...
                      <div class="modern-input-wrapper" :class="{ 'is-focused': nameFocused }">
                        ...
                        <input
                          ...
                          class="modern-input"
                          placeholder="Mfano: John Emmanuel"
                          required
                  ...
                  <div v-else-if="step === 2" key="step2">
                    ...
                    <div class="alert-box info mb-4">
                      ...
                      <div>
                        ...
                        <p>
                          Tumia mchanganyiko wa herufi kubwa, ndogo, namba na alama kwa usalama
                          zaidi.
                        </p>
                      </div>
                    </div>
                    <div class="input-group">
                      ...
                      <div
                        ...
                        :class="{ 'is-focused': regPassFocused, 'is-error': passError }"
                      >
                        <span class="input-icon">🔒</span>
                        <input
                          ...
                          minlength="6"
                          required
                          @focus="regPassFocused = true"
                          @blur="regPassFocused = false"
                        />
                        <button
                          type="button"
                      ...
                      <div class="password-strength" v-if="regForm.password">
                        ...
                        <span class="strength-text" :class="passwordStrengthClass"
                          >Nguvu: {{ passwordStrengthLabel }}</span
                        >
                      </div>
                    </div>
                    <div class="input-group mt-3">
                      ...
                      <div
                        class="modern-input-wrapper"
                        :class="{ 'is-focused': confPassFocused, 'is-error': passError }"
                      >
                        ...
                        <input
                          ...
                          class="modern-input"
                          placeholder="Rudia nenosiri hapa"
                          required
                          minlength="6"
                          @focus="confPassFocused = true"
                          @blur="confPassFocused = false"
                        />
                        <button
                          type="button"
                          class="toggle-pass-btn"
                      ...
                      <span v-if="passError" class="error-msg"
                        >⚠️ Manenosiri uliyoweka hayafanani!</span
                      >
                    </div>
                  </div>
                  ...
                  <div v-else-if="step === 3" key="step3">
                    ...
                    <p class="terms-text mt-3">
                      ...
                      <a href="?privacy=true" @click.prevent="openPrivacy" class="privacy-link"
                        >Sera ya Faragha</a
                      >
                      yetu.
                    </p>
...
const processFacebookAuth = async (accessToken) => {
  try {
    ...
    authError.value =
      ...
      'Kuna shida imejitokeza kuunganisha mfumo na Meta. Tafadhali jaribu tena.'
  }
}
...
const completeRegistration = async () => {
  ...
  try {
    ...
    authError.value =
      error.response?.data?.error || 'Kosa la kimtandao limejitokeza wakati wa usajili.'
  } finally {
    isLoading.value = false
  }
}
...
const handleLogin = async () => {
  ...
  try {
    ...
    isLoading.value = false
    authError.value =
      error.response?.data?.error || 'Taarifa ulizoingiza si sahihi. Hakiki namba na nenosiri.'
  }
}
...
.loader-progress {
  ...
  border-radius: 10px;
  animation:
    loadBar 2.5s ease-in-out forwards,
    shimmer 2s infinite;
}
